...
Then observo a atividade "Acolhimento", profissional "Lucas Mendonça", local "CEU", data inicial "31/12/19", data final "31/12/19"
...
Given eu vejo a atividade "Acolhimento", profissional "Lucas Mendonça", participantes "Roberto To...", local "CEU", data inicial "31/12/19", data final "31/12/19"
When eu aperto em expandir
Then eu vejo atividade "Acolhimento", profissional "Lucas Mendonça", participantes "Roberto Tomás da Silva, Íris Soares dos Santos, Aline Gouveia Matias, Thais Amara Silva de Mendonça", local "CEU", data "31/12/19", data final "31/12/19" expandida
